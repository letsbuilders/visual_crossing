...
# Unit tests for VisualCrossing::TimelineWeatherAPIDateRangeRequestApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TimelineWeatherAPIDateRangeRequestApi' do
  before do
  ...
  describe 'test an instance of TimelineWeatherAPIDateRangeRequestApi' do
    it 'should create an instance of TimelineWeatherAPIDateRangeRequestApi' do
      expect(@api_instance).to be_instance_of(VisualCrossing::TimelineWeatherAPIDateRangeRequestApi)
    end
  end

  # unit tests for visual_crossing_web_services_rest_services_timeline_location_startdate_enddate_get
  ...
  # @return [nil]
  describe 'visual_crossing_web_services_rest_services_timeline_location_startdate_enddate_get test' do
    it 'should work' do
